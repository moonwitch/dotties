...
=for comment
    ...
    beg:      beginning of a category              {begin_cat => ["name", "icon"]},
    end:      end of a category                    {end_cat => undef},
...
our $SCHEMA = [
    ...
    {sep => "$hostname"},
    {item => ['tilix', 'Terminal', 'terminal-emulator']},
    ...
    {item => ['systemctl hibernate', 'Hibernate', 'sleep']},
